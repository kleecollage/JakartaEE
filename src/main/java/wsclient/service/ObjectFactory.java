...
public class ObjectFactory {
    ...
    private final static QName _Sum_QNAME = new QName("http://beans.sum.ws.jax.gm/", "sum");
    private final static QName _SumResponse_QNAME = new QName("http://beans.sum.ws.jax.gm/", "sumResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://beans.sum.ws.jax.gm/", name = "sum")
     ...
     */
    @XmlElementDecl(namespace = "http://beans.sum.ws.jax.gm/", name = "sumResponse")
